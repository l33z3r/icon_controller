from ..v1_core.manager_capabilities import page_manager_capabilities
from ..v1_core.shared_mode_buffer import shared as shared_mode

def _get_handler():
    mode = (shared_mode.get_mode() or "standard_mode").strip().lower()
    return page_manager_capabilities.get(mode) or page_manager_capabilities.get("standard_mode")
